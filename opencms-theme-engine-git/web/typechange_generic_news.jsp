...
<html>
    <head>
        ...
        typeChanger.setTypePattern("^generic\\_news$");
        typeChanger.setOriginalString("opencms://system/modules/net.componio.opencms.modules.eight.skinndriva.rd/schemas/generic_news.xsd");
        typeChanger.setReplacementString("opencms://system/modules/net.componio.opencms.modules.eight.skinndriva.rd.skins.base/schemas/skinndriva_news.xsd");
        typeChanger.setNewTypeName("skinndriva_news");
        typeChanger.setOldSchemaType("GenericNew");
        typeChanger.setNewSchemaType("SkinndrivaNew");
