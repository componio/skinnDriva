...
<html>
    <head>
        ...
        schemaFixer = new SchemaFixer(pageContext, request, response, "/themes-demo/.content/");
        schemaFixer.setTypePattern("^(generic\\_(article|navigation|news))|(custom\\_navigation)|(header\\_image)|(plain\\_page)$");
        //schemaFixer.setOriginalString("opencms://system/modules/net.componio.opencms.modules.eight.skinndriva.rd/schemas/");
        //schemaFixer.setReplacementString("opencms://system/modules/com.diawara.opencms.themes/schemas/");
        ...
        propertyFixer = new PropertyFixer(pageContext, request, response, "/themes-demo/");
        propertyFixer.setTypePattern("^containerpage$");
        propertyFixer.setOriginalPattern("^\\/system\\/modules\\/net\\.componio\\.opencms\\.modules\\.eight\\.skinndriva\\.rd\\/templates\\/(.+)$");
        propertyFixer.setPropertyName(CmsPropertyDefinition.PROPERTY_TEMPLATE);
        //propertyFixer.setPropertyValue("/system/modules/com.diawara.opencms.themes/templates/container-main.jsp");
        propertyFixer.setPropertyValue("/system/modules/net.componio.opencms.modules.eight.skinndriva.rd/templates/main.jsp");
        //propertyFixer.setPropertyValue("");
        propertyFixer.setPropertyType(CmsProperty.TYPE_SHARED);
    ...
    <body>
        <h2>Report for Schema fixing :</h2>
        ${schemaLog}
        <h2>Report for Property fixing :</h2>
        ${propertyLog}
    </body>
</html>
