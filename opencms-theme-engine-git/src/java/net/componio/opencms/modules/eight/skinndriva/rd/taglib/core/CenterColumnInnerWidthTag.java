/*
 *  Document : CenterColumnInnerWidthTag.java
 *  Created on Sa, Jan 21 2012, 20:27:38
 ...
 */
public class CenterColumnInnerWidthTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedCenterColumnInnerWidth();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getCenterColumnInnerWidth());
                }
            }else{
