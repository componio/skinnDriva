/*
 *  Document : BottomMarginTag.java
 *  Created on Sa, Jan 21 2012, 20:34:12
 ...
 */
public class BottomMarginTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(themeCfg.getDimensions().hasMargins()){
                    if(isFormatted()){
                        result = themeCfg.getDimensions().getMargins().getFormattedBottomMargin();
                    }else{
                        result = String.valueOf(themeCfg.getDimensions().getMargins().getBottomMargin());
                    }
                }else{
                    result = isFormatted() ? themeCfg.formatValue(0) : "0";
                }
            }else{
