/*
 *  Document : LeftColumnWidthTag.java
 *  Created on Sa, Jan 21 2012, 20:19:37
 ...
 */
public class LeftColumnWidthTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedLeftColumnWidth();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getLeftColumnWidth());
                }
            }else{
