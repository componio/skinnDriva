/*
 *  Document : HeaderTemplateTag.java
 *  Created on So, Jan 22 2012, 17:33:18
 ...
 */
public class HeaderTemplateTag extends ThemeEngineThemeTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        if(themeCfg != null){
            result = themeCfg.getHeaderTemplate();
