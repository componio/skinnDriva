/*
 *  Document : RightColumnInnerWidthTag.java
 *  Created on Sa, Jan 21 2012, 20:29:43
 ...
 */
public class RightColumnInnerWidthTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedRightColumnInnerWidth();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getRightColumnInnerWidth());
                }
            }else{
