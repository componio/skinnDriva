/*
 *  Document : ToolbarInnerHeightTag.java
 *  Created on Sa, Jan 21 2012, 20:33:06
 ...
 */
public class ToolbarInnerHeightTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedToolbarInnerHeight();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getToolbarInnerHeight());
                }
            }else{
