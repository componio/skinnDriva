/*
 *  Document : DataAreaInnerWidthTag.java
 *  Created on Sa, Jan 21 2012, 20:20:16
 ...
 */
public class DataAreaInnerWidthTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                ...
                // Get the result
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedDataAreaInnerWidth(pageLayout);
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getDataAreaInnerWidth(pageLayout));
                }
            }else{
