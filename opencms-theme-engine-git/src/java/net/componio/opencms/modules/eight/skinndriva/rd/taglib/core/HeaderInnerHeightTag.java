/*
 *  Document : HeaderInnerHeightTag.java
 *  Created on Sa, Jan 21 2012, 20:31:40
 ...
 */
public class HeaderInnerHeightTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedHeaderInnerHeight();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getHeaderInnerHeight());
                }
            }else{
