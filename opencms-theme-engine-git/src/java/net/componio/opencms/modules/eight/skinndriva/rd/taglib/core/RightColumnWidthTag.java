/*
 *  Document : RightColumnWidthTag.java
 *  Created on Sa, Jan 21 2012, 20:29:57
 ...
 */
public class RightColumnWidthTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedRightColumnWidth();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getRightColumnWidth());
                }
            }else{
