/*
 *  Document : IsOfflineProjectTag.java
 *  Created on Sa, Jan 21 2012, 20:11:35
 ...
 */
public class IsOfflineProjectTag extends CommonTagBase{
    /** true if the project is an online projec. Otherwise false. */
    private boolean offlineProject;

    /**
     * 
     */
    public IsOfflineProjectTag(){
        this.offlineProject = false;
    }
    /**
    ...
    public int doEndTag() throws JspException {
        String result = String.valueOf(this.offlineProject);
    ...
    public int doStartTag() throws JspException {
        ...
        this.offlineProject = !currentProject.isOnlineProject();
        tagResult = offlineProject ? CommonTagBase.EVAL_BODY_INCLUDE : CommonTagBase.SKIP_BODY;
