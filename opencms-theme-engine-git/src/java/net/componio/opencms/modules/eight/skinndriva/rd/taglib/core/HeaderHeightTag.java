/*
 *  Document : HeaderHeightTag.java
 *  Created on Sa, Jan 21 2012, 20:31:52
 ...
 */
public class HeaderHeightTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedHeaderHeight();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getHeaderHeight());
                }
            }else{
