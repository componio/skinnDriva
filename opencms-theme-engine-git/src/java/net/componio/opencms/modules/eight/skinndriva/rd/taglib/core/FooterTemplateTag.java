/*
 *  Document : FooterTemplateTag.java
 *  Created on So, Jan 22 2012, 17:34:50
 ...
 */
public class FooterTemplateTag extends ThemeEngineThemeTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        if(themeCfg != null){
            result = themeCfg.getFooterTemplate();
