/*
 *  Document : PageInnerWidthTag.java
 *  Created on Sa, Jan 21 2012, 20:30:58
 ...
 */
public class PageInnerWidthTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedPageInnerWidth();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getPageInnerWidth());
                }
            }else{
