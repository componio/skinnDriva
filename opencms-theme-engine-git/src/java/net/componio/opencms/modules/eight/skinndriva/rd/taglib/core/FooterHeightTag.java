/*
 *  Document : FooterHeight.java
 *  Created on Sa, Jan 21 2012, 20:32:52
 ...
 */
public class FooterHeightTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedFooterHeight();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getFooterHeight());
                }
            }else{
