/*
 *  Document : TopMarginTag.java
 *  Created on Sa, Jan 21 2012, 20:33:36
 ...
 */
public class TopMarginTag extends ThemeEngineDimensionsTagBase{
        ...
        try{
            ...
            if(themeCfg != null){
                if(themeCfg.getDimensions().hasMargins()){
                    if(isFormatted()){
                        result = themeCfg.getDimensions().getMargins().getFormattedTopMargin();
                    }else{
                        result = String.valueOf(themeCfg.getDimensions().getMargins().getTopMargin());
                    }
                }else{
