/*
 *  Document : ShowLeftHandBarTag.java
 *  Created on Fr, Feb 10 2012, 17:57:59
 ...
 */
public class ShowLeftHandBarTag extends ThemeEngineThemeTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        this.writeTagResult(String.valueOf(showLeftHandBar));
    ...
    public int doStartTag() throws JspException {
        ...
        try{
            ...
            propertyObj = actionEl.getCmsObject().readPropertyObject(resURI, "ShowLeftHandBar", true);
            if((propertyObj != null) && (propertyObj.getValue() != null)){
                showLeftHandBar =  Boolean.parseBoolean(propertyObj.getValue());
            }else{
                showLeftHandBar = themeCfg != null ? themeCfg.isShowLeftHandBar() : true;
            }
        ...
        return showLeftHandBar ? ThemeEngineThemeTagBase.EVAL_BODY_INCLUDE : ThemeEngineThemeTagBase.SKIP_BODY;
    }
}
