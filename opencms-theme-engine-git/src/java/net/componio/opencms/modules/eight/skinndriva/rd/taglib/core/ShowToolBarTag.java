/*
 *  Document : ShowToolBarTag.java
 *  Created on Sa, Feb 11 2012, 22:12:57
 ...
 */
public class ShowToolBarTag extends ThemeEngineThemeTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        this.writeTagResult(String.valueOf(showToolBar));
    ...
    public int doStartTag() throws JspException {
        ...
        try{
            ...
            propertyObj = actionEl.getCmsObject().readPropertyObject(resURI, "ShowToolBar", true);
            if((propertyObj != null) && (propertyObj.getValue() != null)){
                showToolBar =  Boolean.parseBoolean(propertyObj.getValue());
            }else{
                showToolBar = themeCfg != null ? themeCfg.isShowToolBar() : true;
            }
        ...
        return showToolBar ? ThemeEngineThemeTagBase.EVAL_BODY_INCLUDE : ThemeEngineThemeTagBase.SKIP_BODY;
    }
}
