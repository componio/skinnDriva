/*
 *  Document : ToolbarTemplateTag.java
 *  Created on So, Jan 22 2012, 17:35:40
 ...
 */
public class ToolbarTemplateTag extends ThemeEngineThemeTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        if(themeCfg != null){
            result = themeCfg.getToolbarTemplate();
