/*
 *  Document : RightMatginTag.java
 *  Created on Sa, Jan 21 2012, 20:33:56
 ...
 */
public class RightMarginTag extends ThemeEngineDimensionsTagBase{
        ...
        try{
            ...
            if(themeCfg != null){
                if(themeCfg.getDimensions().hasMargins()){
                    if(isFormatted()){
                        result = themeCfg.getDimensions().getMargins().getFormattedRightMargin();
                    }else{
                        result = String.valueOf(themeCfg.getDimensions().getMargins().getRightMargin());
                    }
                }else{
