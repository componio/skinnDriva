/*
 *  Document : LeftColumnInnerWidthTag.java
 *  Created on Sa, Jan 21 2012, 20:19:16
 ...
 */
public class LeftColumnInnerWidthTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedLeftColumnInnerWidth();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getLeftColumnInnerWidth());
                }
            }else{
