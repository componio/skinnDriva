/*
 *  Document : PageWidthTag.java
 *  Created on Sa, Jan 21 2012, 20:31:18
 ...
 */
public class PageWidthTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedPageWidth();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getPageWidth());
                }
            }else{
