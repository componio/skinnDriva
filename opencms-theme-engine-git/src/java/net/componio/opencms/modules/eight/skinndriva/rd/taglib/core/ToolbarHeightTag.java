/*
 *  Document : ToolbarHeightTag.java
 *  Created on Sa, Jan 21 2012, 20:33:25
 ...
 */
public class ToolbarHeightTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedToolbarHeight();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getToolbarHeight());
                }
            }else{
