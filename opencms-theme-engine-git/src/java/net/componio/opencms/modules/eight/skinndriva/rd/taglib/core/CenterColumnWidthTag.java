/*
 *  Document : CenterColumnWidthTag.java
 *  Created on Sa, Jan 21 2012, 20:27:56
 ...
 */
public class CenterColumnWidthTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedCenterColumnWidth();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getCenterColumnWidth());
                }
            }else{
