/*
 *  Document : LeftHandTemplateTag.java
 *  Created on So, Jan 22 2012, 17:35:15
 ...
 */
public class LeftHandTemplateTag extends ThemeEngineThemeTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        if(themeCfg != null){
            result = themeCfg.getLeftHandTemplate();
