/*
 *  Document : FooterInnerHeightTag.java
 *  Created on Sa, Jan 21 2012, 20:32:38
 ...
 */
public class FooterInnerHeightTag extends ThemeEngineDimensionsTagBase{
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            if(themeCfg != null){
                if(isFormatted()){
                    result = themeCfg.getDimensions().getFormattedFooterInnerHeight();
                }else{
                    result = String.valueOf(themeCfg.getDimensions().getFooterInnerHeight());
                }
            }else{
