/*
 *  Document : LeftMarginTag.java
 *  Created on Sa, Jan 21 2012, 20:34:27
 ...
 */
public class LeftMarginTag extends ThemeEngineDimensionsTagBase{
        ...
        try{
            ...
            if(themeCfg != null){
                if(themeCfg.getDimensions().hasMargins()){
                    if(isFormatted()){
                        result = themeCfg.getDimensions().getMargins().getFormattedLeftMargin();
                    }else{
                        result = String.valueOf(themeCfg.getDimensions().getMargins().getLeftMargin());
                    }
                }else{
